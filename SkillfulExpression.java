...
public class SkillfulExpression {
...
//				 DivideInteger=false;
			...
			Calculator.executeExpression(expression);
...
class RegexTest {
	...
	public static void diF(String expression) {
		if(expression.contains("/"))
		{
			...
			if(bef.contains("."))
			{
				SkillfulExpression.DivideInteger=false;
				
				break;
			}
			if(SkillfulExpression.hp1.containsKey(bef))
				if(SkillfulExpression.hp1.get(bef).equals("float")||SkillfulExpression.hp1.get(bef).equals("double")){
					SkillfulExpression.DivideInteger=false;
			...
			if(!SkillfulExpression.DivideInteger)
				break;
			for(int i=1;;i++)
			{
			...
			if(SkillfulExpression.hp1.containsKey(aft))
				if(SkillfulExpression.hp1.get(aft).equals("float")||SkillfulExpression.hp1.get(aft).equals("double")){
					SkillfulExpression.DivideInteger=false;
					break;
				}
			//}
